...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Jul 19, 2022 at 04:40 AM
...
INSERT INTO `requests` (`request_id`, `date`, `service`, `status`, `userid`, `title`, `description`) VALUES
(1, '2022-07-19', 'Grocery', 'Normal', 31898, 'Need help shopping for food', 'I need assistance getting to the store to purchase groceries while I recover from my hip surgery.'),
(2, '2022-07-18', 'Yardwork', 'Normal', 39344, 'Help me rake up the leaves', 'I am unable to get all the leaves in my yard raked up. '),
(3, '2022-07-18', 'Disaster Relief', 'Urgent', 135400, 'Flood waters almost to my house', 'I only have a few hours until the flood water reaches our house. Looking for help moving valuables to higher ground.'),
(4, '2022-07-17', 'Other', 'Normal', 331844, 'Clean up the streets', 'Noticing a lot of trash along side the roads. Looking to see if anyone wants to join me in cleaning up out town.');
COMMIT;
